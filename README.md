...
Phone-first loadout builder for Nioh 3. Current version: **v0.9.9**.
...
- `scripts/make_banner.py` — paints the transparent title PNG on deploy
- `scripts/patch_pages.py` — gold theme, Reset All, heading size
